...
public class EcdsaSecp256k1ExampleCava {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Compute the Ethereum address (last 20 bytes of the public key hash)
        byte[] pubKeyBytes = keyPair.publicKey().bytesArray();
        byte[] addressBytes = Hash.keccak256(pubKeyBytes);
        String addressHex = Hex.toHexString(addressBytes, 12, 20);
        System.out.println("Address: " + addressHex);
        //0x166dA4A37720D5C0B9B6F5a82CCbAdf0cD714B42
